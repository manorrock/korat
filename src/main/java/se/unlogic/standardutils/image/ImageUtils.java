...
public class ImageUtils {
	...
	public static BufferedImage scale(BufferedImage image, double xFactor, double yFactor, int imageType) {
		...
		setBackground(g2, result, imageType);
	...
	private static void setBackground(Graphics2D g2, BufferedImage result, int imageType) {

		int inputType = result.getType();

		if(imageType == BufferedImage.TYPE_INT_RGB && (inputType == BufferedImage.TYPE_4BYTE_ABGR || inputType == BufferedImage.TYPE_4BYTE_ABGR_PRE || inputType == BufferedImage.TYPE_INT_ARGB || inputType == BufferedImage.TYPE_INT_ARGB_PRE)){
