...
public class ValidationError extends GeneratedElementable implements Serializable{

	private static final long serialVersionUID = -3342795741111978115L;
	...
	public String toString() {
		...
		return "ValidationError [" + (fieldName != null ? "fieldName=" + fieldName + ", " : "") + (validationErrorType != null ? "validationErrorType=" + validationErrorType + ", " : "") + (messageKey != null ? "messageKey=" + messageKey : "") + (displayName != null ? "displayName=" + displayName : "") + "]";
	}
